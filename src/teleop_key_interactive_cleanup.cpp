...
int InteractiveCleanupTeleopKey::run(int argc, char **argv)
{
  ...
  node_handle_.param<std::string>("sub_msg_to_robot_topic_name",       sub_msg_to_robot_topic_name,       "/interactive_cleanup/message/to_robot");
  node_handle_.param<std::string>("pub_msg_to_moderator_topic_name",   pub_msg_to_moderator_topic_name,   "/interactive_cleanup/message/to_moderator");
  ...
  sub_msg_                = node_handle_.subscribe<interactive_cleanup::InteractiveCleanupMsg>(sub_msg_to_robot_topic_name, 100, &InteractiveCleanupTeleopKey::messageCallback, this);
  pub_msg_                = node_handle_.advertise<interactive_cleanup::InteractiveCleanupMsg>(pub_msg_to_moderator_topic_name, 10);
  sub_joint_state_        = node_handle_.subscribe<sensor_msgs::JointState>(sub_joint_state_topic_name, 10, &InteractiveCleanupTeleopKey::jointStateCallback, this);
